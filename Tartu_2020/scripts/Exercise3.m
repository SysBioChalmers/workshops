...
ecModel_protPool = open('../models/ecModel_batch.mat');
ecModel          = ecModel_protPool.ecModel_protPool;
%Load original model (yeastGEM)
model            = open('../models/yeastGEM.mat');
model            = model.model;
clear ecModel_protPool
...
glucIndexEC   = strcmpi(ecModel.rxnNames,c_source);
